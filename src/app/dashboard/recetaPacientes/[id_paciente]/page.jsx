...
export default function ReecetasPacientes() {
    ...
    function generarPDFReceta() {
        ...
        try {
            ...
            const dibujarEncabezado = () => {
                ...
                doc.text(`Fecha de emisión: ${formatearFechaDocumento(fechaEmision)}`, rightX, 27, {align: "right"});
            ...
            doc.text(doc.splitTextToSize(nombreProfesionalPDF, 68), margin + 4, y + 36);
    ...
    async function insertarFichasPaciente(
        ...
        try {
            ...
            }else if (typeof respuestaBackend.message === 'string' && respuestaBackend.message.includes(`sindato`)){
