...
export default function RecetaRapida() {
    ...
    function generarPDFReceta() {
        ...
        try {
            ...
            doc.text("AgendaClínica — Sistema de Gestión Clínica", margin, 25);
            ...
            doc.text("FECHA DE CADUCIDAD", 80, y);
            ...
            doc.text(new Date(`${fechaCaducidad}T00:00:00`).toLocaleDateString("es-CL"), 80, y + 7);
            doc.setFontSize(9.5);
            doc.text(doc.splitTextToSize(nombreProfesional, rightX - 130), 130, y + 7);
